...
func wireApp(confServer *conf.Server, client *conf.Client, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	feedRepo := data.NewFeeedRepo(dataData, userConn, logger)
