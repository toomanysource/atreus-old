...
var file_user_service_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x95, 0x01, 0x0a, 0x09, 0x42,
	...
	0x77, 0x74, 0x22, 0xc6, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x32, 0x0a,
	0x04, 0x68, 0x74, 0x74, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x75, 0x73,
	...
	0x1e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x63,
	...
	0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xeb, 0x02, 0x0a, 0x04,
	0x44, 0x61, 0x74, 0x61, 0x12, 0x3c, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x65,
	...
	0x73, 0x65, 0x12, 0x33, 0x0a, 0x05, 0x72, 0x65, 0x64, 0x69, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x6f, 0x6e, 0x66, 0x2e, 0x4a, 0x57, 0x54, 0x2e, 0x48, 0x74, 0x74, 0x70, 0x52, 0x04, 0x68, 0x74,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x4a, 0x57, 0x54, 0x2e, 0x47, 0x72, 0x70, 0x63, 0x52, 0x04, 0x67,
	0x72, 0x70, 0x63, 0x1a, 0x23, 0x0a, 0x04, 0x48, 0x74, 0x74, 0x70, 0x12, 0x1b, 0x0a, 0x09, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x4b, 0x65, 0x79, 0x1a, 0x23, 0x0a, 0x04, 0x47, 0x72, 0x70, 0x63,
	0x12, 0x1b, 0x0a, 0x09, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x4b, 0x65, 0x79, 0x42, 0x25, 0x5a,
	0x23, 0x61, 0x70, 0x70, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_user_service_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data)(nil),                // 2: user.service.conf.Data
	(*JWT)(nil),                 // 3: user.service.conf.JWT
	(*Server_HTTP)(nil),         // 4: user.service.conf.Server.HTTP
	(*Server_GRPC)(nil),         // 5: user.service.conf.Server.GRPC
	(*Data_Database)(nil),       // 6: user.service.conf.Data.Database
	(*Data_Redis)(nil),          // 7: user.service.conf.Data.Redis
	(*JWT_Http)(nil),            // 8: user.service.conf.JWT.Http
	(*JWT_Grpc)(nil),            // 9: user.service.conf.JWT.Grpc
...
var file_user_service_internal_conf_conf_proto_depIdxs = []int32{
	...
	2,  // 1: user.service.conf.Bootstrap.data:type_name -> user.service.conf.Data
	3,  // 2: user.service.conf.Bootstrap.jwt:type_name -> user.service.conf.JWT
	4,  // 3: user.service.conf.Server.http:type_name -> user.service.conf.Server.HTTP
	5,  // 4: user.service.conf.Server.grpc:type_name -> user.service.conf.Server.GRPC
	6,  // 5: user.service.conf.Data.database:type_name -> user.service.conf.Data.Database
	7,  // 6: user.service.conf.Data.redis:type_name -> user.service.conf.Data.Redis
	8,  // 7: user.service.conf.JWT.http:type_name -> user.service.conf.JWT.Http
	9,  // 8: user.service.conf.JWT.grpc:type_name -> user.service.conf.JWT.Grpc
	10, // 9: user.service.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	10, // 10: user.service.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	10, // 11: user.service.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	10, // 12: user.service.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
