...
var file_user_service_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3e, 0x0a, 0x09, 0x42, 0x6f,
	...
	0x65, 0x72, 0x52, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0xc6, 0x02, 0x0a, 0x06, 0x53,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x32, 0x0a, 0x04, 0x68, 0x74, 0x74, 0x70, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	...
	0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x53, 0x65, 0x72, 0x76,
	...
	0x6f, 0x75, 0x74, 0x42, 0x25, 0x5a, 0x23, 0x61, 0x70, 0x70, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f,
...
var file_user_service_internal_conf_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_user_service_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_HTTP)(nil),         // 2: user.service.conf.Server.HTTP
	(*Server_GRPC)(nil),         // 3: user.service.conf.Server.GRPC
...
var file_user_service_internal_conf_conf_proto_depIdxs = []int32{
	...
	2, // 1: user.service.conf.Server.http:type_name -> user.service.conf.Server.HTTP
	3, // 2: user.service.conf.Server.grpc:type_name -> user.service.conf.Server.GRPC
	4, // 3: user.service.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	4, // 4: user.service.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
