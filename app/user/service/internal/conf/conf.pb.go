...
var file_user_service_internal_conf_conf_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x04, 0x68, 0x74, 0x74, 0x70, 0x12, 0x32, 0x0a, 0x04, 0x67, 0x72, 0x70, 0x63, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e,
	...
	0x22, 0xeb, 0x02, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x3c, 0x0a, 0x08, 0x64, 0x61, 0x74,
	0x61, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x75, 0x73,
	...
	0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x33, 0x0a, 0x05, 0x72, 0x65, 0x64, 0x69, 0x73,
...
var file_user_service_internal_conf_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_user_service_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_HTTP)(nil),         // 3: user.service.conf.Server.HTTP
	(*Server_GRPC)(nil),         // 4: user.service.conf.Server.GRPC
	(*Data_Database)(nil),       // 5: user.service.conf.Data.Database
	(*Data_Redis)(nil),          // 6: user.service.conf.Data.Redis
...
var file_user_service_internal_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: user.service.conf.Server.http:type_name -> user.service.conf.Server.HTTP
	4,  // 3: user.service.conf.Server.grpc:type_name -> user.service.conf.Server.GRPC
	5,  // 4: user.service.conf.Data.database:type_name -> user.service.conf.Data.Database
	6,  // 5: user.service.conf.Data.redis:type_name -> user.service.conf.Data.Redis
	7,  // 6: user.service.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	7,  // 7: user.service.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	7,  // 8: user.service.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	7,  // 9: user.service.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
