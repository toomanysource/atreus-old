...
type Data struct {
	...
	//	}
	Mysql *Data_Mysql `protobuf:"bytes,1,opt,name=mysql,proto3" json:"mysql,omitempty"` // Redis redis = 2;
}
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x02, 0x74, 0x6f, 0x22, 0x67, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2c,
	...
	0x4d, 0x79, 0x73, 0x71, 0x6c, 0x52, 0x05, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x1a, 0x31, 0x0a, 0x05,
	...
	0x65, 0x6e, 0x4b, 0x65, 0x79, 0x42, 0x2f, 0x5a, 0x2d, 0x41, 0x74, 0x72, 0x65, 0x75, 0x73, 0x2f,
	0x61, 0x70, 0x70, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2f, 0x73, 0x65, 0x72, 0x76,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*JWT_HTTP)(nil),            // 9: kratos.api.JWT.HTTP
	(*JWT_GRPC)(nil),            // 10: kratos.api.JWT.GRPC
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 8: kratos.api.JWT.http:type_name -> kratos.api.JWT.HTTP
	10, // 9: kratos.api.JWT.grpc:type_name -> kratos.api.JWT.GRPC
