...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x54,
	0x0a, 0x06, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x32, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e,
	...
	0x52, 0x02, 0x64, 0x62, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x03, 0x20, 0x01,
	...
	0x6b, 0x65, 0x6e, 0x4b, 0x65, 0x79, 0x22, 0xa5, 0x01, 0x0a, 0x05, 0x4d, 0x69, 0x6e, 0x69, 0x6f,
	...
	0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x53, 0x53, 0x4c, 0x18,
	...
	0x28, 0x09, 0x52, 0x0a, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0x28,
	0x5a, 0x26, 0x61, 0x70, 0x70, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x2f, 0x73, 0x65,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Mysql)(nil),          // 9: user.service.conf.Data.Mysql
	(*Data_Redis)(nil),          // 10: user.service.conf.Data.Redis
	(*JWT_HTTP)(nil),            // 11: user.service.conf.JWT.HTTP
	(*JWT_GRPC)(nil),            // 12: user.service.conf.JWT.GRPC
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 7: user.service.conf.Data.mysql:type_name -> user.service.conf.Data.Mysql
	10, // 8: user.service.conf.Data.redis:type_name -> user.service.conf.Data.Redis
	11, // 9: user.service.conf.JWT.http:type_name -> user.service.conf.JWT.HTTP
	12, // 10: user.service.conf.JWT.grpc:type_name -> user.service.conf.JWT.GRPC
	13, // 11: user.service.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	13, // 12: user.service.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	13, // 13: user.service.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	13, // 14: user.service.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
