...
type Bootstrap struct {
	...
	Server *Server `protobuf:"bytes,1,opt,name=server,proto3" json:"server,omitempty"` //  Data data = 2;
}
...
var file_conf_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x42, 0x0a, 0x09, 0x42, 0x6f, 0x6f, 0x74, 0x73, 0x74, 0x72, 0x61, 0x70,
	...
	0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0xce, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x12, 0x36, 0x0a, 0x04, 0x68, 0x74, 0x74, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x22, 0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e,
	0x48, 0x54, 0x54, 0x50, 0x52, 0x04, 0x68, 0x74, 0x74, 0x70, 0x12, 0x36, 0x0a, 0x04, 0x67, 0x72,
	0x70, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74,
	...
	0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x3b, 0x63, 0x6f,
...
var file_conf_proto_goTypes = []interface{}{
	...
	(*Server_HTTP)(nil),       // 2: relation.service.conf.Server.HTTP
	(*Server_GRPC)(nil),       // 3: relation.service.conf.Server.GRPC
...
var file_conf_proto_depIdxs = []int32{
	...
	2, // 1: relation.service.conf.Server.http:type_name -> relation.service.conf.Server.HTTP
	3, // 2: relation.service.conf.Server.grpc:type_name -> relation.service.conf.Server.GRPC
	4, // 3: relation.service.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	4, // 4: relation.service.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
